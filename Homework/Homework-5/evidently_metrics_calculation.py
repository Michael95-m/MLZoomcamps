...
def calculate_metrics_postgresql(curr, i):
	...
	current_quantile_value = result['metrics'][0]['result']['current']['value']

	curr.execute(
		"insert into dummy_metrics(timestamp, quantile_value) values (%s, %s)",
		(begin + datetime.timedelta(i), current_quantile_value)
	)
